...
class DBHelper extends SQLiteOpenHelper {
    ...
    public DBHelper(Context context, SQLiteDatabase db, String tableN,String [] FieldsN, String [] FieldsT, int nf) {
    ...
    public void createT(SQLiteDatabase db,String tableN,String [] FieldsN,String [] FieldsT, int numberOfFields){
